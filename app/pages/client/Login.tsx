      ...
      <div className="w-full max-w-md space-y-8 rounded-xl bg-white p-8 shadow-lg dark:bg-gray-900 dark:border dark:border-gray-800">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="text-center text-sm">
            ...
            <Link to="/client-signup" className="font-medium text-blue-600 hover:text-blue-500 dark:text-blue-400">
              Sign Up
            </Link>
          </div>
        </form>
        ...
        <div className="mt-6">
          ...
          <div className="mt-6">
            <Button
              ...
              className="w-full flex justify-center items-center gap-2 border-gray-300 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800"
            >
